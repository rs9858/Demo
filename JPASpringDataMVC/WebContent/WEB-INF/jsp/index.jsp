...
<body bgcolor="orange">
	<div>
		...
		<form:form modelAttribute="employee" action="save.html" method="post">
			<div>
				<label for="fname" style="font: italic;color: blue;">First Name</label>
				<div>
					<form:input path="firstName" id="fname" required="true" placeholder="First Name" />
				</div>
			</div>
			<div>
				<label for="lname" style="font: italic;color: blue;">Last Name</label>
				<div>
					<form:input path="lastName" id="lname" required="true" placeholder="Last Name" />
				</div>
			</div>
			<div>
				<label for="desig" style="font: italic;color: blue;">Designation</label>
				<div>
			...
			<div>
				<label for="salary" style="font: italic;color: blue;">Salary</label>
				<div>
		...
		<c:if test="${empList ne null}">
			<table border="2" width="100%" style="border: thin;color: maroon;">
				<tr>
					<th>#</th>
					<th>First Name</th>
					<th>Last Name</th>
